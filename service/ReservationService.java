...
import com.zz.staybooking.exception.ReservationCollisionException;
import com.zz.staybooking.exception.ReservationNotFoundException;
...
public class ReservationService {
    ...
    public List<Reservation> listByGuest(String username) {
        return reservationRepository.findByGuest(new User.Builder()
